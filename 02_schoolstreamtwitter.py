...
ckey="rkz0fM7P3al0pEjrAL1ax25Tv"
csecret="nLNknz49ZFTIGOXnmp8Nigah0w2lcLoc0nw6Hsg0MF0lgZLAfW"
atoken="711534033486749696-RwzrvyCm73aWpJQf18n6Z5RZkVlElOS"
asecret="EZTh8wEB1agKRKf8khvXWTS11zfxvCIFZ1v5JlTzGQg96"
...
while True:
    try:
        ...
        twitterStream.filter(languages=["en"], track=["princeton", "yale", "@columbia", "stanford", "uchicago", "@mit", "dukeu", "@penn", "wharton", "caltech", "johnshopkins", "northwesternu", "ucberkeley", "dartmouth", "@uva ", "nyuniversity", "umich", "sanders", "bern", "berniesanders", "realdonaldtrump", "trump", "clinton", "hillaryclinton", "tedcruz", "wellesley", "obama"], async=True) #insert keywords for Twitter search
